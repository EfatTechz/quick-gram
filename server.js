        ...
        async (msg, match) => {
            ...
            try {
                ...
                if (
                    ...
                    // Give WebApp referral parameter
...
app.post(
    ...
    async (req, res) => {
        ...
        try {
            ...
            //
            // IMPORTANT:
            // Only update if referred_by
            // is still NULL.
            //
            // This helps prevent the same
            // user from generating the
            // referral reward twice.
            // -------------------------

            const {
                data: referralUpdatedUser,
            ...
            // applied the referral.

            if (!referralUpdatedUser) {
