    ...
    async (req, res) => {
        ...
        try {
            ...
            if (currentUserUpdateError) {
                throw currentUserUpdateError;
            }


            console.log(
                `Referral successful: ${referrer.telegram_id} +${REFERRAL_REWARD} Quicks`
            );
            ...
            return res.json({
                ...
                referralEarnings:
                    updatedReferrer.referral_earnings,
